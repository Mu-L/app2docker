<template>
  <div class="pipeline-create-step-git min-w-0">
    <div class="pipeline-field-grid pipeline-field-grid--2">
      <div class="pipeline-field min-w-0">
        <label class="block text-sm font-medium text-slate-700">Git 数据源</label>
        <select
          v-model="formData.source_id"
          class="flex h-9 w-full min-w-0 rounded-md border border-slate-200 px-3 py-1 text-sm"
      ...
      <div class="pipeline-field pipeline-field--full min-w-0">
        ...
        <div class="flex w-full min-w-0 gap-2">
          <select
            ...
            class="min-w-0 flex-1 flex h-9 rounded-md border border-slate-200 px-3 py-1 text-sm"
            :disabled="
              refreshingBranches ||
      ...
      <div class="pipeline-field pipeline-field--full min-w-0">
        <div
          class="flex items-start gap-2 rounded-md border border-slate-200 bg-slate-50 px-3 py-2"
        >
          <input

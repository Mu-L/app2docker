...
<div class="rounded-md border px-3 py-2 text-sm border-sky-200 bg-sky-50 text-sky-900 mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="md:col-span-6">
                  ...
                  <small class="text-slate-500 block mt-1">
                    ...
                    <span v-else>
                      ...
                      <code
                        >{{
                          multiServiceFormData.image_name ||"myapp/demo"
                        }}/服务名</code
                      >
                    </span>
                  </small>
              ...
              >
                <div class="flex items-center gap-2">
                  ...
                  />
                  <label
                    class="text-sm text-slate-700 font-semibold ml-2"
                    for="singleServicePushCheck"
                  >
                    <AppIcon  name="cloud-upload-alt" class="text-green-600" />
                    构建完成后推送到仓库
                  </label>
                </div>
              </div>
            ...
            <div v-if="multiServiceFormData.push_mode === 'multi'" class="mb-3">
              ...
              >
                <label class="block text-sm font-medium text-slate-700 mb-0"><strong>服务列表</strong></label>
                <div class="pipeline-action-group" role="group">
                  ...
                  >
                    <AppIcon  name="check-circle" /> 全部启用
                  </Button>
                  <Button
                    type="button"
                    variant="outline" size="sm"
                    ...
                    :disabled="
                      multiServiceFormData.selected_services.length === 0"
                  >
                    <AppIcon  name="times-circle" /> 全部禁用
                  </Button>
                  <Button
                    type="button"
                    variant="outline" size="sm"
              ...
              <div
                ...
                class="text-slate-500 text-center py-12 border rounded bg-slate-50"
              >
                <AppIcon  name="inbox" class="text-4xl mb-3 text-slate-500" />
                <p class="mb-1">暂无服务</p>
              ...
              <div v-else class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
                ...
                >
                  ...
                  >
                    <div
                      class="border-b border-slate-200 bg-slate-50 px-4 py-3 flex justify-between items-center py-2"
                    >
                      <div class="flex items-center">
                        <span class="inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium bg-blue-600 text-white mr-2"
                          >#{{ index + 1 }}</span
                        >
                        ...
                        >
                          ...
                          >
                            <span
                              :class="multiServiceFormData.service_push_config[
                                  serviceName
                                ]?.enabled !== false
                                  ? 'text-green-600'
                                  : 'text-slate-500'"
                            >
                              <AppIcon
                                :name="multiServiceFormData.service_push_config[
                                    serviceName
                                  ]?.enabled !== false
                                    ? 'check-circle'
                                    : 'times-circle'"
                    ...
                    >
                      <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
                        <div class="col-span-full">
                          <label class="block text-sm font-medium text-slate-700 font-semibold">
                            <AppIcon  name="tag" class="text-blue-600" /> 服务名称
                          ...
                          />
                          <small class="text-slate-500 block mt-1">
                            <AppIcon  name="info-circle" class="text-amber-600" />
                        ...
                        <div class="col-span-full">
                          <label class="block text-sm font-medium text-slate-700 font-semibold">
                            <AppIcon  name="image" class="text-sky-600" /> 镜像名称
                          </label>
                          <input
                            :value="
                              multiServiceFormData.service_push_config[
                          ...
                          <div class="flex items-center gap-2">
                            ...
                            >
                              <AppIcon
                               ...
                               name="cloud-upload-alt" class="text-green-600" />
                              推送到仓库
                            </label>
                          </div>
                        </div>
    ...
    <div v-if="!embedded" class="mt-4 flex justify-end gap-2 border-t border-slate-200 pt-4">
      <Button type="button" size="sm" :disabled="savingMultiServiceConfig" @click="saveMultiServiceConfig">
        <AppIcon v-if="savingMultiServiceConfig"  name="spinner" class="mr-1" spin />
